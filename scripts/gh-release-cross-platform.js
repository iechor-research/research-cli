...
console.log(
  `🚀 Publishing Research CLI Native Wrapper v${version} (Cross Platform) with GitHub CLI\n`,
);
...
Built: ${new Date().toISOString()}`;
  ...
  const releaseNotesFile = path.join(
    ...
    '..',
    'dist-native',
    'release-notes-cross-platform.md',
  );
  ...
  console.log(`\n🍎 macOS (Apple Silicon):`);
  console.log(
    `   curl -L -o research-cli https://github.com/iechor-research/research-cli/releases/download/${tagName}/research-cli-darwin-arm64 && chmod +x research-cli`,
  );

  console.log(`\n🍎 macOS (Intel):`);
  console.log(
    `   curl -L -o research-cli https://github.com/iechor-research/research-cli/releases/download/${tagName}/research-cli-darwin-x64 && chmod +x research-cli`,
  );
  ...
  console.log(`\n🐧 Linux (x64):`);
  console.log(
    `   curl -L -o research-cli https://github.com/iechor-research/research-cli/releases/download/${tagName}/research-cli-linux-x64 && chmod +x research-cli`,
  );
} catch (error) {
