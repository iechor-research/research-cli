...
service:
  ...
  pipelines:
    traces:
      receivers: [otlp]
      processors: [batch]
      exporters: [iechorcloud]
    metrics:
      receivers: [otlp]
      processors: [batch]
      exporters: [iechorcloud, debug]
    logs:
      receivers: [otlp]
      processors: [batch]
      exporters: [iechorcloud, debug]
...
async function main() {
  ...
  console.log(
    '\n🚀 To send telemetry, run the Research CLI in a separate terminal window.',
  );
  ...
  console.log(
    `   - Metrics: https://console.cloud.iechor.com/monitoring/metrics-explorer?project=${projectId}`,
  );
  console.log(
    `   - Traces: https://console.cloud.iechor.com/traces/list?project=${projectId}`,
  );
