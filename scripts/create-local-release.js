...
console.log(
  `🚀 Creating local GitHub Release for Research CLI Native Wrapper v${version}\n`,
);
...
构建时间: ${new Date().toISOString()}`;
  ...
  const ghCommand =
    `gh release create ${tagName} ${uploadFiles.join(' ')} ` +
