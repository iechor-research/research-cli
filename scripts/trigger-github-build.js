...
console.log(
  `🚀 Triggering GitHub Actions build for Research CLI Native Wrapper v${version}\n`,
);
...
try {
  ...
  console.log(`\n🔗 Monitor progress:`);
  console.log(
    `   Actions: https://github.com/iechor-research/research-cli/actions`,
  );
  console.log(
    `   Release: https://github.com/iechor-research/research-cli/releases/tag/${tagName} (after completion)`,
  );

  console.log(`\n📥 After completion, users can install with:`);
  console.log(
    `   curl -sSL https://github.com/iechor-research/research-cli/releases/download/${tagName}/install.sh | bash`,
  );
} catch (error) {
