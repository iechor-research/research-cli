...
interface MockServerConfig {
  ...
  getResearchMdFileCount: Mock<() => number>;
  setResearchMdFileCount: Mock<(count: number) => void>;
  ...
  getAllResearchMdFilenames: Mock<() => string[]>;
  getResearchClient: Mock<() => ResearchClient | undefined>;
  getUserTier: Mock<() => Promise<string | undefined>>;
}

// Mock @iechor/research-cli-core and its Config class
  ...
  const ConfigClassMock = vi
    ...
    .mockImplementation((optionsPassedToConstructor) => {
      ...
      return {
        ...
        researchMdFileCount: opts.researchMdFileCount || 0,
        ...
        setUserMemory: vi.fn(),
        getResearchMdFileCount: vi.fn(() => opts.researchMdFileCount || 0),
        setResearchMdFileCount: vi.fn(),
...
vi.mock('../config/config.js', async (importOriginal) => {
  ...
  return {
    ...
    ...actual,
    loadHierarchicalResearchMemory: vi
      .fn()
...
describe('App UI', () => {
  ...
  it('should display custom contextFileName with plural when set and count is > 1', async () => {
    ...
    mockConfig.getResearchMdFileCount.mockReturnValue(3);
    mockConfig.getDebugMode.mockReturnValue(false);
    mockConfig.getShowMemoryUsage.mockReturnValue(false);
  ...
  describe('with initial prompt from --prompt-interactive', () => {
    it('should submit the initial prompt automatically', async () => {
      ...
      mockConfig.getResearchClient.mockReturnValue({
