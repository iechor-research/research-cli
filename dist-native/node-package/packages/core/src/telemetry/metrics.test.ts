...
describe('Telemetry Metrics', () => {
  ...
  describe('recordTokenUsageMetrics', () => {
    ...
    it('should not record metrics if not initialized', () => {
      recordTokenUsageMetricsModule(mockConfig, 'research-pro', 100, 'input');
    ...
    it('should record token usage for different types', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'research-pro', 50, 'output');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'research-pro', 25, 'thought');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'research-pro', 75, 'cache');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'research-pro', 125, 'tool');
    ...
    it('should handle different models', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'research-ultra', 200, 'input');
      expect(mockCounterAddFn).toHaveBeenCalledWith(200, {
        'session.id': 'test-session-id',
        model: 'research-ultra',
        type: 'input',
      });
    });
  });
