...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from '@iechor/research-cli-core/src/ide/detect-ide.js';

vi.mock('@iechor/research-cli-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    '@iechor/research-cli-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
