...
vi.mock('@iechor/research-cli-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@iechor/research-cli-core')
...
describe('runNonInteractive', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(ResearchClient).mockImplementation(() => mockResearchClient);
    vi.mocked(ToolRegistry).mockImplementation(() => mockToolRegistry);

    mockConfig = {
      getToolRegistry: vi.fn().mockReturnValue(mockToolRegistry),
      getResearchClient: vi.fn().mockReturnValue(mockResearchClient),
