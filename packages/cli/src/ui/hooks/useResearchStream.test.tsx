...
const MockedResearchClientClass = vi.hoisted(() =>
...
vi.mock('@iechor/research-cli-core', async (importOriginal) => {
  ...
  return {
    ...actualCoreModule,
    GitService: vi.fn(),
    ResearchClient: MockedResearchClientClass,
...
// --- Tests for useResearchStream Hook ---
describe('useResearchStream', () => {
  ...
  beforeEach(() => {
    ...
    // Reset mocks for ResearchClient instance methods (startChat and sendMessageStream)
    // The ResearchClient constructor itself is mocked at the module level.
    mockStartChat.mockClear().mockResolvedValue({
      sendMessageStream: mockSendMessageStream,
    } as unknown as any); // ResearchChat -> any
  ...
  const mockLoadedSettings: LoadedSettings = {
    ...
    workspace: { path: '/workspace/.research/settings.json', settings: {} },
    errors: [],
    forScope: vi.fn(),
    setValue: vi.fn(),
  ...
  it('should submit tool responses when all tool calls are completed and ready', async () => {
    ...
    renderHook(() =>
      useResearchStream(
        new MockedResearchClientClass(mockConfig),
        [],
        mockAddItem,
        mockSetShowHelp,
        mockConfig,
  ...
  describe('Slash Command Handling', () => {
    ...
    it('should stop processing and not call Research when a command is handled without a tool call', async () => {
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const { result } = renderHook(() =>
        useResearchStream(
          new MockedResearchClientClass(testConfig),
          [],
          mockAddItem,
          mockSetShowHelp,
          testConfig,
