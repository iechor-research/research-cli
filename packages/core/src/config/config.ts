...
export class Config {
  ...
  private researchMdFileCount: number;
  ...
  constructor(params: ConfigParameters) {
    ...
    this.researchMdFileCount = params.researchMdFileCount ?? 0;
  ...
  async refreshAuth(authMethod: AuthType) {
    ...
    this.researchClient = new ResearchClient(this);
    await this.researchClient.initialize(this.contentGeneratorConfig);
  ...
  async getUserTier(): Promise<UserTierId | undefined> {
    ...
    const generator = this.researchClient.getContentGenerator();
  ...
  getResearchMdFileCount(): number {
    return this.researchMdFileCount;
  }

  setResearchMdFileCount(count: number): void {
    this.researchMdFileCount = count;
  }
  ...
  getResearchClient(): ResearchClient {
  ...
  async refreshMemory(): Promise<{ memoryContent: string; fileCount: number }> {
    ...
    this.setResearchMdFileCount(fileCount);
