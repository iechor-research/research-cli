...
describe('Research Client (client.ts)', () => {
  ...
  beforeEach(async () => {
    ...
    // Because the ResearchClient constructor kicks off an async process (startChat)
  ...
  describe('tryCompressChat', () => {
    ...
    beforeEach(() => {
      ...
      const mockChat: Partial<ResearchChat> = {
        getHistory: vi
          .fn()
          .mockReturnValue([
      ...
      client['chat'] = mockChat as ResearchChat;
    });
  ...
  describe('sendMessageStream', () => {
    ...
    it('should yield MaxSessionTurns and stop when session turn limit is reached', async () => {
      ...
      expect(events).toEqual([{ type: ResearchEventType.MaxSessionTurns }]);
