...
import { Type, mcpToTool } from '@iechor/genai';
...
async function connectAndDiscover(
  ...
  try {
    ...
    for (const funcDecl of tool.functionDeclarations) {
      ...
      // Replace invalid characters (based on 400 error message from Research API) with underscores
      ...
      // (Research API says max length 64, but actual limit seems to be 63)
