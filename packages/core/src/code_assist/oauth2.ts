...
const OAUTH_CLIENT_ID =
  '681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.iechorusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
// Note: It's ok to save this in git because this is an installed application
// as described here: https://developers.iechor.com/identity/protocols/oauth2#installed
...
const SIGN_IN_SUCCESS_URL =
  'https://developers.iechor.com/research-code-assist/auth_success_research';
...
async function authWithUserCode(client: OAuth2Client): Promise<boolean> {
  const redirectUri = 'https://sdk.cloud.iechor.com/authcode_cloudcode.html';
