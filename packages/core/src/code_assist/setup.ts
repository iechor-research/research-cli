...
export class ProjectIdRequiredError extends Error {
  constructor() {
    super(
      'This account requires setting the GOOGLE_CLOUD_PROJECT env var. See https://goo.gle/research-cli-auth-docs#workspace-gca',
    );
  }
}
...
function getOnboardTier(res: LoadCodeAssistResponse): ResearchUserTier {
  if (res.currentTier) {
