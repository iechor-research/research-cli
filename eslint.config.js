          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @iechor/research-cli-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @iechor/research-cli-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@iechor/research-cli-core',
          message: 'Please use relative imports within the @iechor/research-cli-core package.',
        },
      ],
    },
  },
